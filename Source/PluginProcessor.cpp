...
//==============================================================================
const String GameOfLifeAudioProcessor::getName() const
{
...
const String GameOfLifeAudioProcessor::getProgramName (int index)
{
    return {};
}

void GameOfLifeAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void GameOfLifeAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* GameOfLifeAudioProcessor::createEditor()
{
    return new GameOfLifeAudioProcessorEditor (*this);
}

//==============================================================================
void GameOfLifeAudioProcessor::getStateInformation (MemoryBlock& destData)
{
